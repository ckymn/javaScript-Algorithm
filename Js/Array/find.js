...
let founded
// founded = data.find((item) => item.abouts)
founded = data.find(item => item.age >= 37)
//console.log(founded) 

// findIndex -- burda indexOf'tan farkli olarak bir porperies verise isini halledebilir
founded = data.findIndex(item => item.age == 37)
console.log(founded) //0

// indexOf -- burda findIndex'ten farkli olarak spesifik olarak bir elemen ariyor
let array = [1,2,3,4]
